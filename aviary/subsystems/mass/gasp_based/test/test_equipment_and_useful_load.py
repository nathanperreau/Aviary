...
class GaspMultiEngineTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        options.set_val(
            ...
            val=[GASPEngineType.TURBOPROP, GASPEngineType.TURBOJET],
            units='unitless',
        )
        options.set_val(Aircraft.Engine.NUM_ENGINES, val=[2, 4], units='unitless')
        options.set_val(Aircraft.Propulsion.TOTAL_NUM_ENGINES, val=6, units='unitless')
        options.set_val(Settings.VERBOSITY, 0)
